...
class CENet(er.ERModule):
    def __init__(self, config):
        ...
        self.firstconv = nn.Conv2d(config.num_channels, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        ...
        self.finalconv3 = nn.Conv2d(32, config.classes, 3, padding=1)
