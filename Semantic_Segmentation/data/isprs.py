...
class ISPRSLoader(DataLoader, ConfigurableMixin):
    def __init__(self, config):
        ConfigurableMixin.__init__(self, config)
        dataset = ISPRS(self.config.image_dir, self.config.mask_dir, self.config.transforms)
        ...
        super(ISPRSLoader, self).__init__(dataset,
