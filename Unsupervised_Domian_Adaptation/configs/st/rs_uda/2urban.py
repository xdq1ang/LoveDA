from configs.data.loveda.ToURBAN import SOURCE_DATA_CONFIG, TARGET_DATA_CONFIG, EVAL_DATA_CONFIG, TEST_DATA_CONFIG, TARGET_SET
...
SNAPSHOT_DIR = r'log\train_in_loveda\rs_uda'
